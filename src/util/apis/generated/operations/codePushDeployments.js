...
/**
 * Get a specific deployment by its name for the given app
 *
 * @param {string} ownerName The name of the owner
 *
 * @param {string} appName The name of the application
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
 function _getDeploymentByName(ownerName, appName, options, callback) {
  /* jshint validthis: true */
 let client = this.client;
 if(!callback && typeof options === 'function') {
   callback = options;
...
class CodePushDeployments {
  ...
  constructor(client) {
    ...
    this._list = _list;
    this._getDeploymentByName = _getDeploymentByName;
  ...
  /**
   * Gets a specific deployment by its name for the given app
   *
   * @param {string} ownerName The name of the owner
   *
   * @param {string} appName The name of the application
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
   getDeploymentByName(ownerName, appName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      return new Promise((resolve, reject) => {
        self._getDeploymentByName(ownerName, appName, options, (err, result, request, response) => {
          if (err) { reject(err); }
          else { resolve(result); }
          return;
        });
      ...
      return self._getDeploymentByName(ownerName, appName, options, optionalCallback);
    }
  }
